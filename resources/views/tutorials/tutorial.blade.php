    ...
    @include('layouts.sidebar')
      ...
      <div id="main">
            ...
            <div class="w3-row" id="SST" style="margin-top: -55px !important;z-index:-3 !important;">
                <div class="w3-col l12 s6" style="background-color:  #C0AB8E;">
                  <h1 class="text-right" id="jt" style="padding-right: 15px;">
                      <br><br>
                      <b style="font-size:22px;color:#61361e">TUTOR
                      <span style="font-size:32px;color:#f4f0bd">IALS</span></b>
                  </h1>
                </div>
              </div>
        </div>
        ...
        <main class="py-4" style="margin-top:-4% !important;">
            ...
            <div class="w3-row w3-card-4 w3-white">
                <div class="w3-half w3-container" style="width: 40% !important">
                    ...
                    <div class="w3-center" id="qwe" style="margin-top: 35%">
                        ...
                        <br><br>
                      <h1 style="font-size: 45px;">Tutorials</h1>
                    </div>
                    <div class="w3-padding-32">

                        <?php $tutorial = DB::table('tutorials')->where('role', Auth::user()->role)->get();
                        foreach ($tutorial as $tutor){ ?>

                        <div id="{{$tutor->id}}" class="w3-container city w3-animate-opacity w3-card-4 w3-white"
                            style="display:none">
            ...
            <a href="#edituser{{$tutor->id}}" type="button" class="btn btn-outline-warning"
                data-toggle="modal" class="w3-button w3-red">
                Edit <i class="fas fa-pen-square"></i>
            </a>

            <a href="#deleteuser{{$tutor->id}}" type="button" class="btn btn-outline-danger"
                data-toggle="modal" class="w3-button w3-brown">
                Delete <i class="fas fa-dumpster"></i>
            </a>
            <div class="text-left">
            @include('tutorials.edit')
            </div>
            </div>

            <div class="text-left" style="padding-left:24px;">
                <h2 class="w3-text-brown">Tittle: {{$tutor->title}}</h2>
                <h2 class="w3-text-brown">Caption: {{$tutor->caption}}</h2>
            </div>
            <br>
            ...
            data-toggle="modal" data-target="#myModals" style="width: 100%">
                <i class="far fa-file-image"></i>
                <i class="fas fa-plus" style="font-size: 27px;margin-right:-5px;"></i>Add
            </button>
            <div class="text-left">
                @include('tutorials.add')
            </div>
            <br>
                    ...
                    id="tutor">
                      ...
                      <tbody id="myTable">
                        ...
                        ?>
                          ...
                          <td>
                              ......{{substr($tutor->content, -157)}}</td>
                          <td>@php
                            $asst = DB::table('users')
                            ->where('uuid',$tutor->uuid)
                            ->get();
                     foreach ($asst as $key => $u)
                     {
                       echo $u->name;
                          ...
                          <td  style="overflow: hidden !important;">
                            <a href="javascript:void(0)" onclick="openCity(event, '{{$tutor->id}}')"
                                class="w3-button btn-block w3-teal w3-text-white tablink" title="Tutorial!">
                                <i class="far fa-eye" style=""></i> See
                            </a>
                            <a  href="{{ URL::to('/deletetutorial/'.$tutor->id) }}"
