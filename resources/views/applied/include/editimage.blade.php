...
<div class="modal fade" id="editimage<?php echo $id; ?>" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="w3-margin w3-padding-16">
                <form action="{{url('/editimage/'.$users->id)}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <p>
                        ...
                        <input class="w3-input" type="text" value="{{$pro->uuid}}" name="uuid" hidden>
                    </p>
...
{{-- end --}}
  ...
  {{-- for delete --}}
<!-- The Modal -->
<div class="modal" id="deleteimage<?php echo $id; ?>" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
