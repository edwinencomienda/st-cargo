...
<div class="w3-card-4 w3-card-header w3-padding-64">
    <div class="w3-padding-32">
        <div class="w3-row">
            ...
            <div class="w3-half w3-container">
                ...
                <div class="w3-row w3-card-4" style="margin-top: -8%;">
...
<div class="w3-row w3-margin w3-padding-8 w3-card-4 w3-brown">
    <div class="w3-col s12 w3-brown">
        <div>
