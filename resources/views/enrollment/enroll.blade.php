...
<div class="w3-bar w3-card-4">
  ...
  @include('enrollment.enrollrequest')
</div>
</div>
...
<?php $loan = DB::table('enrollment')->where('program', Auth::user()->role)->latest()->get();
