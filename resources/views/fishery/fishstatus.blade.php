...
<div class="w3-row">
  <div class="w3-col l12 s6" style="background-color:  #C0AB8E;">
    <h1 class="text-right" id="jt" style="padding-right: 15px;">
        ...
        <b style="font-size:32px;color:#61361e">CROPS</b>
...
<br><br>
      ...
      <div class="w3-brown w3-rest" style="margin-right: 15px; padding-left:15px;padding-right:15px;">
            ...
            <div class="container-fluid mt-3 w3-padding-16 w3-white" style="width: 100% !important">
                ...
                <ul class="nav nav-tabs container-fluid" style="width: 100% !important">
                  <li class="nav-item">
                    <a class="nav-link active" href="#home">All Request
                        <sup>
                            ...
                            @php
                            $users = DB::table('fishrequest')->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#menu1">Marine Fishing Program
                        <sup>
                            <span class="w3-badge w3-red w3-padding-16">
                            @php
                            $users = DB::table('fishrequest')->where('program',1)->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#menu2">Inaland Aquatic Fishing Program
                        <sup>
                            <span class="w3-badge w3-red w3-padding-16">
                            @php
                            $users = DB::table('fishrequest')->where('program',2)->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#menu3">Boat Program
                        <sup>
                            <span class="w3-badge w3-red w3-padding-16">
                            @php
                            $users = DB::table('fishrequest')->where('program',3)->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
                  ...
                  {{-- <li class="nav-item">
                    <a class="nav-link" href="#menu4">Banana  <sup>
                        <span class="w3-badge w3-red w3-padding-16">
                        @php
                        $users = DB::table('fishrequest')->where('program',4)->count();
                        echo $users;
                          @endphp
                          </span>
                        </sup></a>
      ...
      <br>
          ...
          <br><br>
 <a  href="{{ URL::to('/deletefishrequest/'.$treq->id) }}"
        onclick="return confirm('Do you really want to delete this Fishery Request program?')"
      ...
      {{-- end ni diri sa mga row --}}
          ...
          <?php
               $cropreq = DB::table('fishrequest')->where('program', 1)->latest()->get();
        ...
        Delete <i class="fas fa-dumpster"></i>
          ...
          {{-- end ni diri sa mga row --}}
                ...
                <div id="menu2" class="container-fluid tab-pane fade"><br>
                    <h2>High Value Crops Request</h2>
          ...
          <?php
               $cropreq1 = DB::table('fishrequest')->where('program', 2)->latest()->get();
...
{{--
          ...
          <?php
               $cropreq = DB::table('fishrequest')->where('program', 3)->latest()->get();
foreach ($cropreq as $treq) { ?>
