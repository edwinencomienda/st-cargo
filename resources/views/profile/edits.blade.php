...
<div class="modal" id="editprof{{$ep->id}}" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  {{-- for delete --}}
<!-- The Modal -->
<div class="modal" id="deleteprof{{$ep->id}}" aria-labelledby="myModalLabel" aria-hidden="true">
