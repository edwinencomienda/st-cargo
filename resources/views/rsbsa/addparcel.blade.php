...
<div class="modal fade" id="parcelss">
...
<div class="modal-body w3-display-container">
    ...
    <div class="w3-margin w3-padding-16">
        <form action="{{ route('farmparcel')}}" method="POST" name="adduse" onsubmit="return checkFormparcels(this);">
            @csrf
...
<script>
function checkFormparcels(form) // Submit button clicked
{
