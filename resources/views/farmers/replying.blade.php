...
<div class="w3-row ">
    <div class="w3-col w3-light-gray ffs" style="width:350px"> @include('farmers.include.ins')
...
<a href="{{ URL::to('/farm/conversation/'.$re->id) }}" class="w3-hover-opacity"
    title="Click to Read Message">
        <i class="fas fa-envelope-open"></i>
      </a>
&nbsp;
<a  href="{{ URL::to('/delete/consultation/'.$re->id) }}"
