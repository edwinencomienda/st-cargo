...
<br><br>
      ...
      <div class="w3-brown w3-rest" style="margin-right: 15px; padding-left:15px;padding-right:15px;">
            ...
            <div class="container-fluid mt-3 w3-padding-16 w3-white" style="width: 100% !important">
                ...
                <ul class="nav nav-tabs container-fluid" style="width: 100% !important">
                  <li class="nav-item">
                    <a class="nav-link active" href="#home">All Request
                        <sup>
                            ...
                            @php
                            $users = DB::table('croprequest')->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#menu1">Cereals Request
                        <sup>
                            <span class="w3-badge w3-red w3-padding-16">
                            @php
                            $users = DB::table('croprequest')->where('program',1)->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#menu2">High Value Crops
                        <sup>
                            <span class="w3-badge w3-red w3-padding-16">
                            @php
                            $users = DB::table('croprequest')->where('program',2)->count();
                            echo $users;
                              @endphp
                              </span>
                            </sup>
      ...
      <br>
          <p class="req1">Ready on
              <span class="w3-right">
                  @if ($treq->delivery_date == "")
                      Please set appointment date!
                  @else
                  @php
                  $fdate  = \Carbon\Carbon::parse($treq->delivery_date);
      ...
      {{-- end ni diri sa mga row --}}
          ...
          <?php
               $cropreq = DB::table('croprequest')->where('program', 1)->latest()->get();
foreach ($cropreq as $treq) { ?>
          ...
          <?php
               $cropreq1 = DB::table('croprequest')->where('program', 2)->latest()->get();
        ...
        <div class="w3-container w3-white w3-cell w3-card-4 w3-mobile" style="width: 100% !important">
          ...
          <?php
               $cropreq = DB::table('croprequest')->where('program', 3)->latest()->get();
foreach ($cropreq as $treq) { ?>
          ...
          <?php
               $cropreq = DB::table('croprequest')->where('program',4)->latest()->get();
foreach ($cropreq as $treq) { ?>
