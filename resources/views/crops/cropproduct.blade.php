     ...
     <div class="modal-content w3-padding-32">
       ...
       <div class="modal-body w3-display-container">
           ...
           <div class="w3-margin w3-padding-16">
               <form action="{{ route('cropstore')}}" method="POST"  onsubmit="checkForm(this);">
                   @csrf
                   ...
                   <p>
                       <label class="w3-text-teal">Crop Product</label>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right">
            ...
            <a href="{{ URL::to('/deletecropproduct/'.$inv->id) }}"
                onclick="return confirm('Do you really want to delete this crop products?')" type="button" class="btn btn-outline-danger"
 title="Delete">
