...
<div class="w3-card-4 w3-padding-64 trs">
    <div class="stt">
        <div class="w3-container w3-brown w3-padding-64 w3-cell w3-mobile">
            <div class="container">
                <img src="/backimage/panabo5.jpg" class="w3-sepia-min" width="100%" height="777" alt="">
             </div>
          </div>
...
<div class="w3-left w3-padding-16">
    <h3>
       CAGRO Livestock Sector Programs
    </h3>
     ...
     <div class="modal-content w3-padding-32">
       ...
       <div class="modal-body w3-display-container">
           ...
           <div class="w3-margin w3-padding-16">
               <form action="{{ route('anim.add')}}" method="POST" onsubmit="checkForm(this);">
                   @csrf
                   <p>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right">
            ...
            <a href="{{ URL::to('/livestockservicesremoving/'.$trs->id) }}" type="button"
                class="btn btn-outline-danger" onclick="return confirm('Do you really want to delete this Livestock Service Program?')"
                title="Delete">
    ...
    <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content w3-padding-32">
       ...
       <div class="modal-body w3-display-container">
        @php
        $a = $trs->id;
           $users = DB::table('animalservice')->where('id', $a)->get();
           foreach ($users as $u) {
       ...
       @endphp
           ...
           <div class="w3-margin w3-padding-16">
               <form action="{{url('/livestockservices/updating/'.$u->id)}}" method="POST" onsubmit="checkFormz(this);">
                   @csrf
                   <p>
