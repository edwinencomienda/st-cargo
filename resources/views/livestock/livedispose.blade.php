        ...
        <main class="py-4" style="margin-bottom: -3%">
            ...
            <div class="w3-row w3-padding-64 w3-brown">
                ...
                {{-- <sup> <span class="w3-badge w3-red w3-padding-16" title="Today's Request">
                    @php
                    $users = DB::table('cropdispose')->where('delivery_date', Now())->count();
                    echo $users;
                      @endphp
                      </span></sup> --}}
                </h1>
                    ...
                    {{-- <div class="w3-container w3-cell w3-mobile">
                        <div class="w3-card-4">
                            ...
                            <header class="w3-container w3-white w3-padding-16">
                             <h3>Cereals Program Left</h3>
                            </header>

                            <div class="w3-container w3-padding-16 text-center ">
                                <h3>
                                @php
                                $users = DB::table('cropinventory')->where('service_type',1)->sum('qty')
...
echo  $bg->lname . ' '. $bg->fname . ', ' . $bg->mname;
                ...
                <td>{{$dis->programs}} -
                    @php
                    $sss = DB::table('animalservice')->where('id', $dis->programs)->get();
...
<br>
                ...
                @include('livestock.livesockdispose')
               </td>
              </tr>
              @endforeach
